...
with tab1:
    ...
    Selain nilai seninya yang tinggi, kartun juga memiliki kegunaan yang beragam, mulai dari tampilan cetak hingga digunakan sebagai alat bercerita dalam pendidikan anak.''')
with tab2:
    # Input gambar
